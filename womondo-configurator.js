...
var countryLabel = (getCountryLabelFromUI() || currentCountry || '').trim();
...
var gross = ex.priceGross || 0;
var name = ex.name || 'Extra';
y = ensureSpace(10, y);
...
// PDF button click binding (one-time, delegated)
